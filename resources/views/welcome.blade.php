...
<main class="flex flex-wrap md:flex-nowrap py-20 container gap-10">
    ...
    <div class="flex flex-col justify-around text-center md:text-left relative">
        <div class="relative">
            <div class="self-end md:self-center absolute bottom-4 right-3 max-w[100px] md:hidden pb-10 -z-10">
            ...
            <h6 class="font-semibold  text-3xl py-10 md:pt-3">Let Get You Started</h6>
        </div>
